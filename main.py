...
print("Genie Music Lyrics Downloader\n다운로드한 가사는 바탕화면의 'output' 폴더에 추가됩니다.\n")
...
while True:
    ...
    if str(artists_list) == '[]':
        ...
        print('Enter between 1~15 or enter 0 to cancel')
        ...
        elif ( int(index) > 0 and int(index) < 16): 
            print("Processing...")
            
            song_id = ids_list[int(index) - 1]
            # print(song_id)
